        ...
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                    <a href="" class="nav-item nav-link">Danh mục 1</a>
                    <a href="" class="nav-item nav-link">Danh mục 2</a>
                    <a href="" class="nav-item nav-link">Danh mục 3</a>
                    <a href="" class="nav-item nav-link">Danh mục 4</a>
                    <a href="" class="nav-item nav-link">Danh mục 5</a>
                    <a href="" class="nav-item nav-link">Danh mục 6</a>
                    <a href="" class="nav-item nav-link">Danh mục 7</a>
                </div>
            </nav>
        </div>
        <div class="col-lg-9">
